...
NETWORK=${SCRIPT_DIR}/../../../../inputs/network/garnet/Non-Uniform/Non-Uniform-DOR
WORKLOAD=${SCRIPT_DIR}/../../../../inputs/workload/Non-Uniform/0.txt
SYSTEM=${SCRIPT_DIR}/../../../../inputs/system/Non-Uniform/22.txt
BASE_STATS_DIR=${SCRIPT_DIR}/../../../../examples/results/Non_Uniform_MoE/No_Fault
