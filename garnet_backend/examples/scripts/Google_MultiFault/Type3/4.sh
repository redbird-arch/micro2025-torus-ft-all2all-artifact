...
NETWORK=${SCRIPT_DIR}/../../../../inputs/network/garnet/Google_MultiFault/Type3
WORKLOAD=${SCRIPT_DIR}/../../../../inputs/workload/All_To_All_512KB.txt
SYSTEM=${SCRIPT_DIR}/../../../../inputs/system/Google.txt
BASE_STATS_DIR=${SCRIPT_DIR}/../../../../examples/results/Google_MultiFault/Type3
SYNTHETIC="--synthetic=training"

# === Set run parameters ===
system_base=4
run_name="Google_MultiFault_Type3_${system_base}"
