...
NETWORK=${SCRIPT_DIR}/../../../../../inputs/network/garnet/Google_comp/844_1_1
WORKLOAD=${SCRIPT_DIR}/../../../../../inputs/workload/All_To_All_256KB.txt
SYSTEM=${SCRIPT_DIR}/../../../../../inputs/system/Google.txt
BASE_STATS_DIR=${SCRIPT_DIR}/../../../../../examples/results/Google_comp/844/WFR_F1
SYNTHETIC="--synthetic=training"

# === Set run parameters ===
system_base=3
run_name="Google_comp_844_WFR_F1_${system_base}"
