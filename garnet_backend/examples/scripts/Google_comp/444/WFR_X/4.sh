...
NETWORK=${SCRIPT_DIR}/../../../../../inputs/network/garnet/Google_comp/444_x
WORKLOAD=${SCRIPT_DIR}/../../../../../inputs/workload/All_To_All_512KB.txt
SYSTEM=${SCRIPT_DIR}/../../../../../inputs/system/Google.txt
BASE_STATS_DIR=${SCRIPT_DIR}/../../../../../examples/results/Google_comp/444/WFR_X
SYNTHETIC="--synthetic=training"

# === Set run parameters ===
system_base=4
run_name="Google_comp_444_WFR_X_${system_base}"
