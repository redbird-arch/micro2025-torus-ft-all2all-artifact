...
NETWORK=${SCRIPT_DIR}/../../../../../inputs/network/garnet/Google_comp/444_0
WORKLOAD=${SCRIPT_DIR}/../../../../../inputs/workload/All_To_All_512KB.txt
SYSTEM=${SCRIPT_DIR}/../../../../../inputs/system/Google.txt
BASE_STATS_DIR=${SCRIPT_DIR}/../../../../../examples/results/Google_comp/444/DOR
SYNTHETIC="--synthetic=training"

# === Set run parameters ===
system_base=4
run_name="Google_comp_444_DOR_${system_base}"
