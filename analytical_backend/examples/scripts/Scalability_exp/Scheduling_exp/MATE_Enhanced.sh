...
SYSTEM_DIR=${SCRIPT_DIR}/../../../../inputs/system/Scalability_scheduling_exp/MATE_Enhanced
WORKLOAD_DIR=${SCRIPT_DIR}/../../../../inputs/workload/Scalability_exp/Weak
STATS_DIR=${SCRIPT_DIR}/../../../../examples/results/Scalability_exp/Scheduling_weak/MATE_Enhanced
