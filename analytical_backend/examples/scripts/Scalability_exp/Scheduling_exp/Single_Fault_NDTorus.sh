...
SYSTEM_DIR=${SCRIPT_DIR}/../../../../inputs/system/Scalability_scheduling_exp/Tolerance_single_NDTorus
WORKLOAD_DIR=${SCRIPT_DIR}/../../../../inputs/workload/Scalability_exp/Weak
STATS_DIR=${SCRIPT_DIR}/../../../../examples/results/Scalability_exp/Scheduling_weak/Single_Fault_NDTorus
