...
SYSTEM_DIR=${SCRIPT_DIR}/../../../../inputs/system/Synthetic_exp/Ring_No_Fault_NDTorus
WORKLOAD_DIR=${SCRIPT_DIR}/../../../../inputs/workload/Scalability_exp/Weak
STATS_DIR=${SCRIPT_DIR}/../../../../examples/results/Scalability_exp/Algorithm_weak/No_Fault_Ring
