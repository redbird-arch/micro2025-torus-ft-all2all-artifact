...
SYSTEM_DIRS=("${SCRIPT_DIR}/../../../inputs/system/Synthetic_exp/HalfRing_No_Fault_Pipeline" "${SCRIPT_DIR}/../../../inputs/system/Synthetic_exp/HalfRing_No_Fault_NDTorus")
NETWORK_DIR="${SCRIPT_DIR}/../../../inputs/network/analytical/Synthetic_exp"
STATS_DIR="${SCRIPT_DIR}/../../../examples/results/Synthetic_exp/No_Fault_HalfRing"
