...
SYSTEM_DIRS=("${SCRIPT_DIR}/../../../inputs/system/Synthetic_exp/Tolerance_single_Pipeline" "${SCRIPT_DIR}/../../../inputs/system/Synthetic_exp/Tolerance_single_NDTorus")
NETWORK_DIR="${SCRIPT_DIR}/../../../inputs/network/analytical/Synthetic_exp"
STATS_DIR="${SCRIPT_DIR}/../../../examples/results/Synthetic_exp/Single_Fault"
...
for workload_file in ${WORKLOAD_DIR}/*.txt; do
    ...
    for system_dir in "${SYSTEM_DIRS[@]}"; do
        ...
        for system_file in ${system_dir}/*.txt; do
            ...
            network_file="${NETWORK_DIR}/Fault_Tolerance_Baseline_single_${dim}.json"
