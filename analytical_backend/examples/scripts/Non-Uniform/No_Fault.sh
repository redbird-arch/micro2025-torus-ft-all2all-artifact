...
SYSTEM_DIR="${SCRIPT_DIR}/../../../inputs/system/Non-Uniform/No_Fault"
NETWORK_FILE="${SCRIPT_DIR}/../../../inputs/network/analytical/Google_comp/TPUv4_4x4x4_NoFault.json"
STATS_DIR="${SCRIPT_DIR}/../../../examples/results/Non_Uniform_MoE/No_Fault"
